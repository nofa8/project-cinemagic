...
class MoviesPerGenreLast7DaysSheet implements FromCollection, WithHeadings, WithTitle
{
    public function collection()
    {
        return Movie::join('genres', 'movies.genre_code', '=', 'genres.code')
            ...
            ->whereBetween('screenings.date', [now()->subDays(7), now()])
            ->groupBy('genres.name')
            ->get()
            ->map(function ($item) {
    ...
    {
        return 'MoviesPerGenreLast7Days';
    }
}
