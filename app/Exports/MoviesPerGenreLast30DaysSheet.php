...
class MoviesPerGenreLast30DaysSheet implements FromCollection,WithHeadings, WithTitle
{
    public function collection()
    {
        return Movie::join('genres', 'movies.genre_code', '=', 'genres.code')
            ...
            ->whereBetween('screenings.date', [now()->subDays(30), now()])
            ->groupBy('genres.name')
            ->get()
            ->map(function ($item) {
    ...
    {
        return 'MoviesPerGenreLast30Days';
    }
}
