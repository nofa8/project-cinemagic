...
class TicketsPerTheaterLastDaySheet implements FromCollection, WithHeadings, WithTitle
{
    public function collection()
    {
        return Ticket::join('purchases', 'purchases.id', '=', 'tickets.purchase_id')
            ...
            ->whereBetween('purchases.date', [now()->subDays(1), now()])
    ...
    {
        return 'TicketsPerTheaterLastDay';
    }
}
