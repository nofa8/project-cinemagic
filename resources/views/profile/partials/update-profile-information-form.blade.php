    ...
    <div class="flex-grow space-y-4">
        <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
            ...
            <div>
                ...
                <x-text-input id="nif" name="nif" type="text" :value="old('nif', $user->customer?->nif)" required autofocus autocomplete="name" />
            ...
            <div>
                ...
                <x-text-input id="payment_ref" name="payment_ref" type="text" :value="old('payment_ref', $user->customer?->payment_ref)" required autofocus autocomplete="name" />
